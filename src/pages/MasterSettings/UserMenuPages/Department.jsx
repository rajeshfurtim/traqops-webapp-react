    ...
    const handleDelete = async () => {
        try {
            const queryString = selectedRowKeys
                .map(id => `id=${id}`)
                .join('&');
            const response = await deleteDepartment(queryString).unwrap();
    ...
    return (
        <>
            <Box>
                    ...
                    <CardContent>
                            ...
                            <Space>
                                <>
                                    {selectedRowKeys.length > 0 && (
                                        <>
                                            <Popconfirm
                                                title={`Are you sure you want to delete ${selectedRowKeys.length} selected department(s)?`}
                        ...
                        {departmentListLoading || isFetching ? (
                            ...
                            <Table
                                ...
                                loading={departmentListLoading || isFetching}
                                rowKey="id"
                                size="middle"
                ...
                <Modal
                    title={selectedRecord ? "Edit Department" : "Add Department"}
                    open={isModalOpen}
