    ...
    const handleDelete = async () => {
        try {
            const queryString = selectedRowKeys
                .map(id => `id=${id}`)
                .join('&');
            const response = await deleteSkillLevel(queryString).unwrap();
    ...
    return (
        <>
            <Box>
                    ...
                    <CardContent>
                            ...
                            <Space>
                                <>
                                    {selectedRowKeys.length > 0 && (
                                        <>
                                            <Popconfirm
                                                title={`Are you sure you want to delete ${selectedRowKeys.length} selected skill level(s)?`}
                        ...
                        {skillLevelListLoading ? (
                            ...
                            <Table
                                ...
                                loading={skillLevelListLoading || isFetching}
                                rowKey="id"
                                size="middle"
                ...
                <Modal
                    title={selectedRecord ? "Edit Skill Level" : "Add Skill Level"}
                    open={isModalOpen}
