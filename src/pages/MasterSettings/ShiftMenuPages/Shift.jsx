    ...
    const handleDelete = async () => {
        try {
            const queryString = selectedRowKeys
                .map(id => `id=${id}`)
                .join('&');
            const response = await deleteShift(queryString).unwrap();
                    ...
                    <CardContent>
                            ...
                            <Space>
                                <>
                                    {selectedRowKeys.length > 0 && (
                                        <>
                                            <Popconfirm
                                                title={`Are you sure you want to delete ${selectedRowKeys.length} selected shift(s)?`}
                        ...
                        {shiftListLoading ? (
                            ...
                            <Table
                                ...
                                loading={shiftListLoading || isFetching}
                                rowKey="id"
                                size="middle"
